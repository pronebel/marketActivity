...
Page({
  ...
  setTitleList(res) {
    ...
    if (res.status) {
      ...
      this.setData({
        ...
        isMusic: activityBase.hasBgm == 1 ? activityBase.bgmName : modify.isMusic,
        idsMusic: activityBase.hasBgm == 1 ? activityBase.bgmId : modify.idsMusic,
  ...
  choiseTles() { //标题选择
    ...
    Create.sloganChoose(this, 'FREEPRODUCT')
  },
